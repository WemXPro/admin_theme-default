    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('categories.create') }}" class="btn btn-primary"><i class="fas fa-solid fa-plus"></i> {!! __('admin.create_category') !!}</a>
                    <hr>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    <td>{{ $category->id }}</td>
                                    <td><img alt="image" src="{{ asset('storage/products/' . $category->icon) }}" class="rounded-circle" width="35" data-toggle="tooltip" title="" data-original-title="{{ $category->name }}"></td>
                                    <td>{{ $category->name }}</td>
                                    <td>{{ $category->link }}</td>
