            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a onclick="openTab('home')" class="nav-link nav-link-tab active" id="home_tab" data-toggle="tab"
                                href="#home" role="tab" aria-controls="home" aria-selected="true">Package</a>
                        </li>
                        <li class="nav-item">
                            <a onclick="openTab('features')" class="nav-link nav-link-tab" id="features_tab" data-toggle="tab"
                                href="#features" role="tab" aria-controls="features" aria-selected="false">Features</a>
                        </li>
                        <li class="nav-item">
                            <a onclick="openTab('profile')" class="nav-link nav-link-tab" id="profile_tab" data-toggle="tab"
                                href="#profile" role="tab" aria-controls="profile" aria-selected="false">Prices</a>
                        </li>
                        <li class="nav-item">
                            <a onclick="openTab('contact')" class="nav-link nav-link-tab" id="contact_tab" data-toggle="tab"
                                href="#contact" role="tab" aria-controls="contact" aria-selected="false">Service
                                Provider</a>
                        </li>
                        <li class="nav-item">
                            <a onclick="openTab('emails')" class="nav-link nav-link-tab" id="emails_tab" data-toggle="tab"
                                href="#emails" role="tab" aria-controls="emails" aria-selected="false">
                                Emails</a>
                        </li>
                        <li class="nav-item">
                            <a onclick="openTab('webhooks')" class="nav-link nav-link-tab" id="webhooks_tab" data-toggle="tab"
                        ...
                        <li class="nav-item">
                            <a onclick="openTab('links')" class="nav-link nav-link-tab" id="links_tab" data-toggle="tab"
                                href="#links" role="tab" aria-controls="links" aria-selected="false">Links</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-6">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" name="status"
                                            ...
                                            <option value="unlisted" @if ($package->status == 'unlisted') selected @endif>
                                                Unlisted (only users with direct link can view)
                                            </option>
                                            <option value="restricted" @if ($package->status == 'restricted') selected @endif>
                                                Admin Only (only administrators can view)
                                            </option>
                                            <option value="inactive" @if ($package->status == 'inactive') selected @endif>
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        ...
                                        <textarea class="summernote form-control" name="description" id="description" style="display: none;">
                                        @isset($package->description) {!! $package->description !!} @endisset
                                        </textarea>
                                        <small class="form-text text-muted">Separate each individual feature with the <code>[+]</code> tag. Example: <code>8 GB RAM [+] 1 TB SSD [+] 2 TB Bandwith</code></small>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="form-group col-md-6 col-6">
                                        <label for="stock">Global Stock</label>
                                        <input type="number" name="global_stock" id="stock" min="-1"
                                            value="{{ $package->global_quantity }}" class="form-control" required="" />
                                        <small class="form-text text-muted">Client stock indicates the stock limit per
                                            client. Set to <code>-1</code> to allow unlimited</small>
                                    </div>

                                    <div class="form-group col-md-6 col-6">
                                        <label for="stock">Per Client Stock</label>
                                    ...
                                    <div class="form-group col-md-6 col-6">
                                        <div class="form-group">
                                            <div class="control-label">Require Domain</div>
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" name="require_domain" class="custom-switch-input" value="1" @if($package->require_domain) checked @endif>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">Does this package require the user
                                                    to have a domain?</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-6">
                                        <div class="form-group">
                                            <div class="control-label">Allow Notes</div>
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" name="allow_notes" class="custom-switch-input" value="1" @if($package->allow_notes) checked @endif>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">
                                                    Allow users to include special notes / additional information.
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile_tab">
                            <button class="btn btn-primary mt-4 mb-4" data-toggle="modal"
                                data-target="#createPriceModal">New Price</button>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($prices as $price)
                                        <tr>
                                            <td>Billed {{ $price->periodToHuman() }}</td>
                                            <td>
                                                @if($price->is_active)
                                                <div class="flex align-items-center">
                                                    <i class="fas fa-solid fa-circle  text-success " style="font-size: 11px;"></i> Active
                                                </div>
                                                @else
                                                <div class="flex align-items-center">
                                                    <i class="fas fa-solid fa-circle  text-danger " style="font-size: 11px;"></i> Inactive
                                                </div>
                                                @endif
                                            </td>
                                            <td>{{ currency('symbol') }}{{ $price->price }}</td>
                                            <td>{{ currency('symbol') }} @isset($price->renewal_price) {{ $price->renewal_price }}
                                                @else
                                                    {{ $price->price }}
                                        @endif
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn btn-primary mt-4 mb-4" data-toggle="modal"
                                                data-target="#editPriceModal-{{ $price->id }}">Edit</button>
                                            <a href="{{ route('package_price.delete', ['price' => $price->id]) }}"
                                                class="btn btn-icon icon-left btn-danger"><i class="fas fa-trash"></i>
                                                Delete</a>
                                        </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form
                                                        ...
                                                        @csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Editing Price Cycle</h5>
                                                        ...
                                                        <div class="modal-body modal-lg">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-12 col-12">
                                                                    ...
                                                                    <input type="number" name="setup_fee" id="setup_fee"
                                                                        min="0.00" step="0.01"
                                                                        value="{{ $price->setup_fee }}" class="form-control"
                                                                        required="" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-md-12 col-12">
                                                                    ...
                                                                    <textarea type="text" name="data" id="data-{{ $price->id }}" class="form-control">@json($price->data)</textarea>
                                                            ...
                                                            <div class="row" id="price-options-{{ $price->id }}">
                                                                <div class="form-group col-md-6 col-6">
                                                                    ...
                                                                    <label class="custom-switch mt-2">
                                                                        ...
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Use Custom
                                                                            Renewal Price</span>
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6 col-6">
                                                                    ...
                                                                    <label class="custom-switch mt-2">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            class="custom-switch-input">
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Setup
                                                                ...
                                                                <div class="col-md-12 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="custom-switch mt-2">
                                                                            <input type="checkbox" name="is_active" class="custom-switch-input" value="1" @if($price->is_active) checked @endif>
                                                                            <span class="custom-switch-indicator"></span>
                                                                            <span class="custom-switch-description">You can deactivate price if you no longer wish to display it.</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact_tab">
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" onchange="updateService()"
                            ...
                            <div class="tab-pane fade" id="emails" role="tabpanel" aria-labelledby="emails_tab">
                                ...
                                <button type="button" class="btn btn-primary mt-4 mb-4" data-toggle="modal" data-target="#createEmail">
                                    {{ __('admin.create') }}
                                </button>

                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    WemX already sends a set of emails when an order is cancelled, suspended or terminated. You can configure them <a target="_blank" href="/admin/emails/messages"><strong>here</strong></a>
                                ...
                                <!-- Create Email Modal -->
                                <div class="modal fade bd-example-modal-lg" id="createEmail" tabindex="-1" role="dialog" aria-labelledby="createEmailLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="{{ route('packages.emails.create', $package->id) }}" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                            @csrf
                                            <div class="mb-4">
                                                <label for="event">Event</label>
                                                <select class="form-control select2 select2-hidden-accessible" name="event"
                                                    tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="">
                                                ...
                                                <textarea class="summernote form-control" name="body" id="body" style="display: none;">
                                                </textarea>
                                        ...
                                        <table class="table table-striped table-md">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{ route('packages.emails.delete', ['email' => $email->id]) }}" class="btn btn-icon btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        <button  data-toggle="modal" data-target="#editEmail{{$email->id}}" class="btn btn-primary">Manage</button>
                                                    </td>
                                                </tr>

                                                    <!-- Create Email Modal -->
                                                    <div class="modal fade bd-example-modal-lg" id="editEmail{{$email->id}}" tabindex="-1" role="dialog" aria-labelledby="editEmail{{$email->id}}Label" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editEmail{{$email->id}}Label">Email Event</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="{{ route('packages.emails.update', ['email' => $email->id]) }}" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                                @csrf
                                                                <div class="mb-4">
                                                                    <label for="event">Event</label>
                                                                    <select class="form-control select2 select2-hidden-accessible" name="event"
                                                                        tabindex="-1" aria-hidden="true">
                                                                        <option value="creation" @if($email->event == 'creation') selected @endif>
                                                                            Creation
                                                                        </option>
                                                                        <option value="renewal" @if($email->event == 'renewal') selected @endif>
                                                                            Renewal
                                                                        </option>
                                                                        <option value="suspension" @if($email->event == 'suspension') selected @endif>
                                                                            Suspension
                                                                        </option>
                                                                        <option value="unsuspension" @if($email->event == 'unsuspension') selected @endif>
                                                                            Unsuspension
                                                                        </option>
                                                                        <option value="cancellation" @if($email->event == 'cancellation') selected @endif>
                                                                            Cancellation
                                                                        </option>
                                                                        <option value="termination" @if($email->event == 'termination') selected @endif>
                                                                            Termination
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="mb-4">
                                                                    <label for="title">Email Title</label>
                                                                    <input type="text" name="title" id="title" value="{{ $email->title }}" placeholder="Subject"
                                                                        class="form-control" required="" />
                                                                </div>
                                                                ...
                                                                @if($email->attachment)
                                                                    <span class="badge badge-pill badge-secondary">{{ basename($email->attachment) }}</span>
                                                                @endif
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            ...
                            <div class="tab-pane fade" id="webhooks" role="tabpanel" aria-labelledby="webhooks_tab">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary mt-4 mb-4" data-toggle="modal" data-target="#createWebhook">
                                    {{ __('admin.create') }}
                                </button>

                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    Package webhooks are a powerful feature allowing you to do a huge amount of things. You can also use custom variables inside webhooks. <a href="https://docs.wemx.net/en/setup/packages#package-webhooks" target="_blank">Learn More</a>
                                </div>
                                ...
                                <div class="modal fade bd-example-modal-lg" id="createWebhook" tabindex="-1" role="dialog" aria-labelledby="createWebhookLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="{{ route('packages.webhooks.create', $package->id) }}" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                            @csrf
                                            <div class="mb-4">
                                                <label for="event">Event</label>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible" name="method"
                                                    tabindex="-1" aria-hidden="true">

                                                    @foreach(['get', 'post', 'put', 'patch', 'delete', 'head'] as $key => $method)
                                                    <option value="{{ $method }}" style="text-transform: uppsercase">
                                                        {{ strtoupper($method) }}
                                                    </option>
                                                    @endforeach
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="url" name="url" id="url" placeholder="https://example.com/api/v1"
                                                    class="form-control" required="" />
                                            </div>

                                            <div class="mb-4">
                                                <label for="data">Data</label>
                                                <textarea class="form-control" name="data" id="data" placeholder='{"key": "value"}' style="height: 200px !important"></textarea>
                                                <small class="form-text text-muted"></small>
                                            </div>

                                            <div class="mb-4">
                                                <label for="headers">Headers</label>
                                                <textarea class="form-control" name="headers" id="headers" placeholder='{"Authorization": "Bearer apikey"}'></textarea>
                                                <small class="form-text text-muted"></small>
                                            </div>
                                        ...
                                        <table class="table table-striped table-md">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{ route('packages.webhooks.delete', ['webhook' => $webhook->id]) }}" class="btn btn-icon btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        <button  data-toggle="modal" data-target="#editWebhook{{$webhook->id}}" class="btn btn-primary">Manage</button>
                                                    </td>
                                                </tr>

                                                    <!-- Create Email Modal -->
                                                    <div class="modal fade bd-example-modal-lg" id="editWebhook{{$webhook->id}}" tabindex="-1" role="dialog" aria-labelledby="editWebhook{{$webhook->id}}Label" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editWebhook{{$webhook->id}}Label">Webhook Event</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="{{ route('packages.webhooks.update', ['webhook' => $webhook->id]) }}" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                                @csrf
                                                                <div class="mb-4">
                                                                    <label for="event">Event</label>
                                                                    <select class="form-control select2 select2-hidden-accessible" name="event"
                                                                        tabindex="-1" aria-hidden="true">
                                                                        <option value="creation" @if($webhook->event == 'creation') selected @endif>
                                                                            Creation
                                                                        </option>
                                                                        <option value="renewal" @if($webhook->event == 'renewal') selected @endif>
                                                                            Renewal
                                                                        </option>
                                                                        <option value="suspension" @if($webhook->event == 'suspension') selected @endif>
                                                                            Suspension
                                                                        </option>
                                                                        <option value="unsuspension" @if($webhook->event == 'unsuspension') selected @endif>
                                                                            Unsuspension
                                                                        </option>
                                                                        <option value="cancellation" @if($webhook->event == 'cancellation') selected @endif>
                                                                            Cancellation
                                                                        </option>
                                                                        <option value="termination" @if($webhook->event == 'termination') selected @endif>
                                                                            Termination
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <select class="form-control select2 select2-hidden-accessible" name="method"
                                                                        ...
                                                                        @foreach(['get', 'post', 'put', 'patch', 'delete', 'head'] as $key => $method)
                                                                            <option value="{{ $method }}" style="text-transform: uppsercase" @if($webhook->method == $method) selected @endif>
                                                                                {{ strtoupper($method) }}
                                                                            </option>
                                                                        @endforeach
                                                                ...
                                                                <div class="mb-4">
                                                                    <label for="url">URL</label>
                                                                    <input type="url" name="url" id="url" placeholder="https://example.com/api/v1"
                                                                        class="form-control" value="{{ $webhook->url }}" required="" />
                                                                </div>

                                                                <div class="mb-4">
                                                                    <label for="data">Data</label>
                                                                    <textarea class="form-control" name="data" id="data" placeholder='{"key": "value"}' style="height: 200px !important">{{ json_encode($webhook->data, JSON_PRETTY_PRINT) }}</textarea>
                                                                    <small class="form-text text-muted"></small>
                                                                </div>

                                                                <div class="mb-4">
                                                                    <label for="headers">Headers</label>
                                                                    <textarea class="form-control" name="headers" id="headers" placeholder='{"Authorization": "Bearer apikey"}'>{{ json_encode($webhook->headers, JSON_PRETTY_PRINT) }}</textarea>
                                                                    <small class="form-text text-muted"></small>
                                                                </div>
                            ...
                            <div class="tab-pane fade" id="links" role="tabpanel" aria-labelledby="links_tab">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" value="{{ route('store.package', $package->id) }}" readonly="">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" value="{{ route('payment.package', ['package' => $package->id, 'price_id' => '1', 'gateway' => '1']) }}" readonly="">
                                        <small class="form-text text-muted">
