                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="amount" value="5.00" min="0.01"
                                           step="0.01" max="999" required=""/>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 col-12">
                                ...
                                <input type="text" class="form-control" name="coupon"
                                       placeholder="{!! __('admin.coupon') !!}">
                            </div>

                            <div class="orm-group col-md-4 col-12">
                                <div
                                    class="control-label">{!! __('admin.payment_enable_due_date', ['default' => 'Enable due date']) !!}</div>
