        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ nav_active('admin/settings', prefix: true) }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="nav-link {{ nav_active('admin.settings.theme') }}" href="{{ route('admin.settings.theme') }}">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="nav-link {{ nav_active('admin.themes') }}" href="{{ route('admin.themes') }}">
                            {!! __('admin.client_themes') !!}
                        </a>
                    </li>
                    <li>
                        <a class="nav-link {{ nav_active('admin.admin_themes') }}" href="{{ route('admin.admin_themes') }}">
                            {!! __('admin.admin_themes') !!}
                        </a>
                    </li>
                </ul>
            </li>
