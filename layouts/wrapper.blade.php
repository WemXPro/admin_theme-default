                                        ...
                                        <a href="#" class="dropdown-item dropdown-item-unread">
                                            <div class="dropdown-item-desc">
                                                ...
                                                <div class="time text-primary">
                                                    {{ $notificaiton->created_at->diffForHumans() }}</div>
                                            </div>
                                        </a>
                                    @endforeach
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="nav-link {{ nav_active('pages.index') }}" href="{{ route('pages.index') }}"><i
                                    class="fas fa-solid fa-file"></i>
                                <span>{!! __('admin.expenses', ['default' => 'Expenses']) !!}</span></a>
                        </li>

                        <li>
                            <a class="nav-link {{ nav_active('articles.index') }}"
                                href="{{ route('articles.index') }}"><i class="fas fa-solid fa-newspaper"></i>
                        ...
                        <li
                            class="dropdown {{ nav_active(['categories.index', 'packages.index', 'coupons.index']) }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                        ...
                        <li>
                            <a class="nav-link {{ nav_active('gateways.index') }}"
                                href="{{ route('gateways.index') }}"><i class="fas fa-solid fa-credit-card"></i>
                        ...
                        <li>
                            <a class="nav-link {{ nav_active('modules.view') }}"
                                href="{{ route('modules.view') }}"><i class="fas fa-solid fa-plug"></i>
                                <span>{!! __('admin.modules') !!}</span></a>
                        </li>

                        <li>
                            <a class="nav-link {{ nav_active('services.view') }}"
                                href="{{ route('services.view') }}"><i class="fas fa-solid fa-robot"></i>
                            ...
                            @if (config($module->getLowerName() . '.elements.admin_menu'))
                                @foreach (config($module->getLowerName() . '.elements.admin_menu') as $key => $menu)
                                    @if (isset($menu['type']) and $menu['type'] == 'dropdown')
                                        <li
                                            class="dropdown  {{ nav_active($module->getLowerName(), dropdown: true) }}">
                    ...
                    @foreach ($errors->all() as $error)
                        <div class="alert alert-danger">
                            <a href="#" style="background: #0000003d;" class="badge badge-danger">
                                <i class="fas fa-solid fa-bell" style="margin-left: 0px"></i></a>
                            {!! $error !!}
                        </div>
                    @endforeach
                @endif
                ...
                @if (Settings::get('maintenance') == 'true' && Auth::user()->is_admin())
                    <div class="alert alert-warning">
                        ...
                        {!! __('admin.maintenance_mode_desc', [
                            'default' => 'Maintenance mode is active, you are currently bypassing maintenance mode',
                        ]) !!}
                        <a href="/admin/settings/store?maintenance=false"
                            class="btn btn-icon icon-left btn-primary ml-2"><i
