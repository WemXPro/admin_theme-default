                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <textarea class="summernote form-control @error('description') is-invalid @enderror" name="content" id="content"
                            ...
                            <div class="form-group col-md-4 col-12">
                                <div class="control-label">{!! __('admin.allow_guests', ['default' => 'Allow Guests']) !!}</div>
                            ...
                            <div class="form-group col-md-4 col-12">
                                <div class="control-label">{{ __('admin.show_author') }}</div>
                                <label class="custom-switch mt-2">
                            ...
                            <div class="form-group col-md-4 col-12">
                                <div class="control-label">{{ __('admin.allow_comments') }}</div>
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" name="allow_comments" class="custom-switch-input" value="1"
                                        checked="">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">
